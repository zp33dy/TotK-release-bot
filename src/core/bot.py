...
class Inu(lightbulb.BotApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.load("src/ext/commands/")
        self.load("src/ext/tasks/")
    ...
    def load_task(self):
        for extension in os.listdir(os.path.join(os.getcwd(), "src/ext/tasks")):
            if (
                extension == "__init__.py" 
                or not extension.endswith(".py")
                or extension.startswith("_")
    ...
    def print_banner_(self):
        path = f"{os.getcwd()}/src/data/text/banner.txt"
